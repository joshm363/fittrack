...
interface WorkoutRepository {
    ...
    suspend fun addSet(sessionExerciseId: Long, setNumber: Int, weight: Double = 0.0, reps: Int = 0): Long
    ...
    suspend fun getPreviousSetsForExercise(exerciseId: Long): List<ExerciseSet>
    suspend fun getAllCompletedSetsForExercise(exerciseId: Long): List<ExerciseSet>
}
